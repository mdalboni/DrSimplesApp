    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(act, CadastroConsultaActivity.class);
        ...
        mRecyclerView = (RecyclerView) findViewById(R.id.consulta_card);
    ...
    void atualizar(int cod) {
        ...
        call.enqueue(new Callback<PacConsulta>() {
            ...
            public void onResponse(Call<PacConsulta> call, Response<PacConsulta> response) {
                ...
                mAdapter = new ConsultaAdapter(lista, act);
