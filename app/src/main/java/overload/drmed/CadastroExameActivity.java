...
import overload.drmed.overload.drmed.adapters.LaboratorioAdapter;
...
public class CadastroExameActivity extends AppCompatActivity
    ...
    CadastroExameActivity act = this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView = (RecyclerView) findViewById(R.id.laboratorio_card);
        ...
        Dialog.callOfTheProgressBar(CadastroExameActivity.this);
        ...
        btn_pesquisar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Interfaces.ConsultarLaboratorios api = retrofit.create(Interfaces.ConsultarLaboratorios.class);
                Call<Laboratorios> call = api.getLaboratorios(txt_cidade.getText().toString(),txt_pesquisar.getText().toString(),itemsID2[cmb_Convenios.getSelectedItemPosition()]+"");

                call.enqueue(new Callback<Laboratorios>() {
                    @Override
                    public void onResponse(Call<Laboratorios> call, Response<Laboratorios> response) {
                        boolean end = response.body().isSuccess();
                        if (response.code() == 200 && end) {
                            List<Laboratorios.Laboratorio> lista = response.body().getLaboratorio();
                            extras[3] = itemsIDPC2[cmb_Convenios.getSelectedItemPosition()]+"";
                            mAdapter = new LaboratorioAdapter(lista, act,extras);
                    ...
                    @Override
                    public void onFailure(Call<Laboratorios> call, Throwable t) {
